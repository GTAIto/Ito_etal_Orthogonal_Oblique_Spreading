...
for imod=1:5
    ...
    elseif (imod==6)
        ...
        fig2='2'; cd cd LaMEM_Input_Files_Output_Folders/L30M35-75Nu1.5Weak50;  logdir='log'; mpw=1e3; dtave=0.2;
    elseif (imod==7)
        fig2='2'; cd cd LaMEM_Input_Files_Output_Folders/L30M45-75Nu1.5Weak50;  logdir='log'; mpw=1e3; dtave=0.3; istep=410;
    elseif (imod==8)
        fig2='2'; cd cd LaMEM_Input_Files_Output_Folders/L30M55-75Nu1.5Weak50;  logdir='log'; mpw=1e3; dtave=0.3; istep=400;
    elseif (imod==9)
        fig2='2'; cd cd LaMEM_Input_Files_Output_Folders/L30M65-75Nu1.5Weak50;  logdir='log'; mpw=1e3; dtave=0.5; istep=370;
    end
%--------------------------------------------------------------------------
% Parse model params
%--------------------------------------------------------------------------
